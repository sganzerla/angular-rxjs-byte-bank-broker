...
export declare class PoTableRowTemplateDirective {
    ...
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<PoTableRowTemplateDirective, "[p-table-row-template]", never, { "tableRowTemplateArrowDirection": "p-table-row-template-arrow-direction"; "poTableRowTemplateShow": "p-table-row-template-show"; }, {}, never>;
}
