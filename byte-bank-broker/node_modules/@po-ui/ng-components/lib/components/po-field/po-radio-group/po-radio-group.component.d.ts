...
export declare class PoRadioGroupComponent extends PoRadioGroupBaseComponent implements AfterViewInit, DoCheck {
    ...
    private isArrowKey;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PoRadioGroupComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PoRadioGroupComponent, "po-radio-group", never, { "label": "p-label"; "help": "p-help"; }, {}, never, never>;
}
