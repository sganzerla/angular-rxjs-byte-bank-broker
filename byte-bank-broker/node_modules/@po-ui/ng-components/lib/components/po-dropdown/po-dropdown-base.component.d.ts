...
export declare class PoDropdownBaseComponent {
    ...
    label: string;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PoDropdownBaseComponent, never>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<PoDropdownBaseComponent, never, never, { "actions": "p-actions"; "disabled": "p-disabled"; "label": "p-label"; }, {}, never>;
}
