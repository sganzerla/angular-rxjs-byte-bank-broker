...
export declare class PoTagComponent extends PoTagBaseComponent implements OnInit {
    ...
    get iconTypeString(): boolean;
    get tagColor(): string;
    get tagOrientation(): boolean;
    onClick(): void;
    onKeyPressed(event: any): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PoTagComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PoTagComponent, "po-tag", never, {}, {}, never, never>;
}
