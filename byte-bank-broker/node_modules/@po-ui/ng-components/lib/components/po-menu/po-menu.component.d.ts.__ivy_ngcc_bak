...
export declare class PoMenuComponent extends PoMenuBaseComponent implements OnDestroy, OnInit, DoCheck {
    ...
    constructor(changeDetector: ChangeDetectorRef, viewRef: ViewContainerRef, element: ElementRef, renderer: Renderer2, router: Router, menuItemsService: PoMenuItemsService, menuService: PoMenuService, languageService: PoLanguageService);
