(function (global, factory) {
    ...
    (global = global || self, factory((global['po-ui'] = global['po-ui'] || {}, global['po-ui']['ng-templates'] = {}), global.ng.core, global.ng.common, global.ng.forms, global.i2, global.ng.router, global.ng.common.http, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var PoPageBlockedUserComponent = /** @class */ (function (_super) {
        ...
        function PoPageBlockedUserComponent(activatedRoute, router, languageService) {
            ...
            _this.literals = Object.assign(Object.assign({}, poPageBlockedUserButtonLiterals[poLocaleDefault]), poPageBlockedUserButtonLiterals[language]);
            return _this;
        }
    ...
    var PoPageChangePasswordComponent = /** @class */ (function (_super) {
        ...
        function PoPageChangePasswordComponent(activatedRoute, route, router, service, poComponentInjector, languageService, viewRef) {
            ...
            _this.literals = poPageChangePasswordLiterals[poLocaleDefault];
            ...
            var language = languageService.getShortLanguage();
            _this.literals = Object.assign(Object.assign({}, poPageChangePasswordLiterals[poLocaleDefault]), poPageChangePasswordLiterals[language]);
            return _this;
        }
    ...
    var PoPageDynamicTableComponent = /** @class */ (function (_super) {
        ...
        function PoPageDynamicTableComponent(router, activatedRoute, poDialogService, poNotification, poPageDynamicService, poPageCustomizationService, poPageDynamicTableActionsService, languageService) {
            ...
            var language = languageService.getShortLanguage();
            _this.literals = Object.assign(Object.assign({}, poPageDynamicTableLiteralsDefault[poLocaleDefault]), poPageDynamicTableLiteralsDefault[language]);
            return _this;
        }
        ...
        Object.defineProperty(PoPageDynamicTableComponent.prototype, "pageActions", {
            get: function () {
                return __spread(this._pageActions, this.customPageListActions);
            },
            enumerable: false,
            configurable: true
        });
        ...
        PoPageDynamicTableComponent.prototype.transformCustomActionsToPageListAction = function (customActions) {
            var _this = this;
            return customActions.map(function (customAction) {
                return {
                    label: customAction.label,
                    action: _this.callCustomAction.bind(_this, customAction),
                    disabled: _this.isDisablePageCustomAction.bind(_this, customAction)
                };
            });
        };
        ...
        PoPageDynamicTableComponent.prototype.callCustomAction = function (customAction) {
    ...
    var PoPageJobSchedulerComponent = /** @class */ (function (_super) {
        ...
        function PoPageJobSchedulerComponent(poPageDynamicLookupService, activatedRoute, poDialogService, poNotification, poPageJobSchedulerService) {
            ...
            _this.isEdit = false;
            _this.literals = Object.assign(Object.assign({}, poPageJobSchedulerLiteralsDefault[poLocaleDefault]), poPageJobSchedulerLiteralsDefault[browserLanguage()]);
            _this.parameters = [];
            _this.step = 1;
            ...
            _this.concludePageActions = [
                ...
                Object.assign({}, _this.backPageAction)
            ];
