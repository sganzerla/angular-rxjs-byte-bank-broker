...
import { PoDialogService, PoDynamicFormField, PoNotificationService, PoPageAction, PoStepperItem } from '@po-ui/ng-components';
...
export declare class PoPageJobSchedulerComponent extends PoPageJobSchedulerBaseComponent implements OnInit {
    ...
    constructor(poPageDynamicLookupService: PoPageJobSchedulerLookupService, activatedRoute: ActivatedRoute, poDialogService: PoDialogService, poNotification: PoNotificationService, poPageJobSchedulerService: PoPageJobSchedulerService);
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PoPageJobSchedulerComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PoPageJobSchedulerComponent, "po-page-job-scheduler", never, {}, {}, never, never>;
}
