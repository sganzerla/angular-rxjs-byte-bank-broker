...
import { PoDialogService, PoLanguageService, PoNotificationService, PoTableAction, PoTableColumnSort } from '@po-ui/ng-components';
...
export declare class PoPageDynamicTableComponent extends PoPageDynamicListBaseComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PoPageDynamicTableComponent, "po-page-dynamic-table", never, { "keepFilters": "p-keep-filters"; "concatFilters": "p-concat-filters"; "actions": "p-actions"; "pageCustomActions": "p-page-custom-actions"; "onLoad": "p-load"; }, {}, never, never>;
}
